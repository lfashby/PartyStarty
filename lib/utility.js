...
var client = require('twilio')(process.env.twilio_sid || config.twilio_sid, process.env.twilio_auth || config.twilio_auth);
                        ...
                        if (err) {
                          ...
                          if (phone) {
                            ...
                            client.messages.create({
                              ...
                              `,
                              to: phone,
                              from: process.env.twilio_number || config.twilio_number
                            })
